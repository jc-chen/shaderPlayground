...
var mode = Part.EYES; // Initial mode
...
var leftEyePosition = {
  type: 'v3',
  value: new THREE.Vector3(-0.14, 2.43, -0.65)
}
...
lasers.rightLaser = new THREE.Mesh(laserGeometry, rightLaserMaterial);
lasers.leftLaser = new THREE.Mesh(laserGeometry, leftLaserMaterial);

scenes[Part.LASERS].add(lasers.rightLaser);
scenes[Part.LASERS].add(lasers.leftLaser);
