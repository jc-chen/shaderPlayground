...
lighting.p = new THREE.Mesh(lighting.sphere, new THREE.MeshPhongMaterial({color: 0xFFFFFF}));
lighting.p.position.set(-5, 1, 1);
scenes[Part.LIGHTING].add(lighting.p);
...
loadOBJ(Part.ANISOTROPIC,'obj/bunny.obj', anisotropicMaterial,0.3,4.5,0,-5.2,0,-1,0);
loadOBJ(Part.ANISOTROPIC,'obj/male.obj', anisotropicMaterial,0.02,-1,0,1,0,3,0);
loadOBJ(Part.ANISOTROPIC,'obj/armadillo.obj', anisotropicMaterial,1,4,1,-4,0,2.5,0);
loadOBJ(Part.ANISOTROPIC,'obj/car.obj', anisotropicMaterial,0.05,-5,0,1.5,-Math.PI/2,0,Math.PI/3);
...
anisotropic.sphere_aniso.scale.set(0.3,0.3,0.3);
anisotropic.sphere_aniso.position.set(2.6,2,-2.6);
...
loadOBJ(Part.TOON,'obj/bunny.obj', toonMaterial,0.3,4.5,0,-5.2,0,-1,0);
loadOBJ(Part.TOON,'obj/male.obj', toonMaterial,0.02,-1,0,1,0,3,0);
loadOBJ(Part.TOON,'obj/armadillo.obj', toonMaterial,1,4,1,-4,0,2.5,0);
loadOBJ(Part.TOON,'obj/car.obj', toonMaterial,0.05,-5,0,1.5,-Math.PI/2,0,Math.PI/3);

toon.sphere = new THREE.SphereGeometry(1, 16, 16);
toon.npr_toon = new THREE.Mesh(toon.sphere, toonMaterial);
toon.npr_toon.scale.set(0.3,0.3,0.3);
toon.npr_toon.position.set(2.6,2,-2.6);
